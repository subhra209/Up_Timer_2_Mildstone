...
//Tower Lamp
#define 	GREEN_LAMP						PORTEbits.RE1			
#define		GREEN_LAMP_DIRECTION			TRISEbits.TRISE1
#define 	RED_LAMP						PORTEbits.RE2			
#define		RED_LAMP_DIRECTION				TRISEbits.TRISE2

#define 	CLOCK_LED					PORTAbits.RA5
#define 	CLOCK_LED_DIRECTION			TRISAbits.TRISA5
